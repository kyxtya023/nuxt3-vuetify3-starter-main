...
const _imports_0$3 = "" + buildAssetsURL("4db54979-24dc-4cb4-a0fa-54c3e03ab58d.Cvzm0oel.jpg");
const _imports_1$2 = "" + buildAssetsURL("3cb75436-2636-4a15-98f2-01f5116a54b6.Drx2HuD_.jpg");
const _imports_2$1 = "" + buildAssetsURL("8df28ea8-26c3-4e68-8248-ebbf33ff55a4.DfRfXUDS.jpg");
const _imports_3 = "" + buildAssetsURL("e2e51fae-f4df-4a6b-ad8a-78d5f228a5ad.CYDhf-jS.jpg");
const _imports_4 = "" + buildAssetsURL("76636daefdd44b058addb6c6bd1ac107.CkryDl_V.jpg");
      ...
      ssrRenderList(__props.questions, (item, index2) => {
        ...
        ssrRenderList(item.content, (block, blockIndex) => {
          ...
          if (block.type === "highlighted-text") {
            _push(`<p class="highlighted-text" data-v-bdfba351>${(_a = splitText(block.text)) != null ? _a : ""}</p>`);
          } else {
            _push(`<!---->`);
          }
          if (block.type === "highlighted-background-text") {
            _push(`<p class="highlighted-background-text" data-v-bdfba351>${(_b = splitText(block.text)) != null ? _b : ""}</p>`);
          } else {
            _push(`<!---->`);
          }
          if (block.type === "text") {
            _push(`<p class="question__text" data-v-bdfba351>${(_c = splitText(block.text)) != null ? _c : ""}</p>`);
          } else {
            _push(`<!---->`);
          }
          if (block.type === "list") {
            ...
            ssrRenderList(block.lists, (list, listIndex) => {
              ...
              if (list.title) {
                _push(`<p class="question__list-title" data-v-bdfba351>${(_a2 = splitText(list.title)) != null ? _a2 : ""}</p>`);
              } else {
                _push(`<!---->`);
              }
              ...
              ssrRenderList(list.items, (listItem, itemIndex) => {
                var _a3;
                _push(`<li class="question__list-item" data-v-bdfba351><p data-v-bdfba351>${(_a3 = splitText(listItem)) != null ? _a3 : ""}</p></li>`);
              });
              _push(`<!--]--></ul></div>`);
            });
            _push(`<!--]--></div></div>`);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "footer" }, _attrs))} data-v-26538e98><div class="container" data-v-26538e98><div class="footer__inner" data-v-26538e98><div class="footer__top" data-v-26538e98><div class="footer__left-column" data-v-26538e98><div class="footer__logo" data-v-26538e98><a href="#" data-v-26538e98><img${ssrRenderAttr("src", _imports_0$2)} alt="Logo" data-v-26538e98></a></div></div><div class="footer__right-column" data-v-26538e98><p class="footer__list-title" data-v-26538e98>\u041A\u043E\u043D\u0442\u0430\u043A\u0442\u044B</p><div class="block-text" style="${ssrRenderStyle({ "display": "flex", "flex-direction": "column", "gap": "0.5rem" })}" data-v-26538e98><a class="footer__button-link" href="tel:+1234567890" target="_blank" aria-label="\u041F\u043E\u0437\u0432\u043E\u043D\u0438\u0442\u044C" data-v-26538e98>+7 (977) 263-40-00</a><a class="footer__button-link" href="mailto:" data-v-26538e98>yt@ya.ru</a></div></div></div><div class="footer__bottom" data-v-26538e98><p class="footer__text" data-v-26538e98> \u0412\u0441\u0435 \u043F\u0440\u0430\u0432\u0430 \u0437\u0430\u0449\u0438\u0449\u0435\u043D\u044B \xA9 2016 \u2013 2024 \u0426\u0435\u043D\u044B \u043D\u0430 \u0441\u0430\u0439\u0442\u0435 \u0434\u043B\u044F \u043E\u0437\u043D\u0430\u043A\u043E\u043C\u043B\u0435\u043D\u0438\u044F \u2014 \u043D\u0435 \u044F\u0432\u043B\u044F\u044E\u0442\u0441\u044F \u043F\u0443\u0431\u043B\u0438\u0447\u043D\u043E\u0439 \u043E\u0444\u0435\u0440\u0442\u043E\u0439, \u043E\u043F\u0440\u0435\u0434\u0435\u043B\u044F\u0435\u043C\u043E\u0439 \u043F\u043E\u043B\u043E\u0436\u0435\u043D\u0438\u044F\u043C\u0438 \u0441\u0442\u0430\u0442\u044C\u0438 437 \u0413\u0440\u0430\u0436\u0434\u0430\u043D\u0441\u043A\u043E\u0433\u043E \u043A\u043E\u0434\u0435\u043A\u0441\u0430 \u0420\u043E\u0441\u0441\u0438\u0439\u0441\u043A\u043E\u0439 \u0424\u0435\u0434\u0435\u0440\u0430\u0446\u0438\u0438. \u041A\u043E\u043C\u043F\u0430\u043D\u0438\u044F \u043E\u0441\u0442\u0430\u0432\u043B\u044F\u0435\u0442 \u0437\u0430 \u0441\u043E\u0431\u043E\u0439 \u043F\u0440\u0430\u0432\u0430 \u0431\u0435\u0437 \u0443\u0432\u0435\u0434\u043E\u043C\u043B\u0435\u043D\u0438\u044F \u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044F \u0438\u0437\u043C\u0435\u043D\u044F\u0442\u044C \u0446\u0435\u043D\u044B \u043D\u0430 \u0441\u0430\u0439\u0442\u0435 </p></div></div></div></footer>`);
}
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (currentStep.value === 1) {
        _push(`<div class="quiz__step" data-v-729a1106><h2 class="quiz__title" data-v-729a1106> \u0423\u043A\u0430\u0436\u0438\u0442\u0435 \u043F\u0440\u0438\u043C\u0435\u0440\u043D\u0443\u044E \u043F\u043B\u043E\u0449\u0430\u0434\u044C \u043C\u044F\u0433\u043A\u043E\u0433\u043E \u043E\u0441\u0442\u0435\u043A\u043B\u0435\u043D\u0438\u044F \u0432 \u043C\xB2 </h2><div class="quiz__slider-container" data-v-729a1106><div class="quiz__slider-wrapper" style="${ssrRenderStyle(sliderProgressStyle.value)}" data-v-729a1106><input type="range" min="1" max="100"${ssrRenderAttr("value", answers.value.area)} class="quiz__slider" data-v-729a1106></div><p class="quiz__slider-value" data-v-729a1106>${ssrInterpolate(answers.value.area)} \u043C\xB2</p></div></div>`);
      } else {
        _push(`<!---->`);
      }
...
//# sourceMappingURL=index-C2Amgmvw.mjs.map
