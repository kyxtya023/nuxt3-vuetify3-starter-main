...
import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, setResponseHeaders, createError, getRouterParam, getQuery as getQuery$1, readBody, sendError, getResponseStatusText } from 'file://D:/nuxt3-vuetify3-starter-main/node_modules/h3/dist/index.mjs';
import TelegramBot from 'file://D:/nuxt3-vuetify3-starter-main/node_modules/.pnpm/node-telegram-bot-api@0.66.0_request@2.88.2/node_modules/node-telegram-bot-api/index.js';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://D:/nuxt3-vuetify3-starter-main/node_modules/vue-bundle-renderer/dist/runtime.mjs';
...
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL } from 'file://D:/nuxt3-vuetify3-starter-main/node_modules/ufo/dist/index.mjs';
...
import { consola } from 'file://D:/nuxt3-vuetify3-starter-main/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://D:/nuxt3-vuetify3-starter-main/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://D:/nuxt3-vuetify3-starter-main/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file://D:/nuxt3-vuetify3-starter-main/node_modules/.pnpm/vue@3.5.13_typescript@5.7.2/node_modules/vue/index.mjs';
...
const _XWmyU1ZZEo = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "D:/nuxt3-vuetify3-starter-main";
...
const _lazy_9MoWCY = () => Promise.resolve().then(function () { return sendMessage$1; });
const _lazy_Su5swv = () => Promise.resolve().then(function () { return renderer$1; });
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:\\nuxt3-vuetify3-starter-main\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const sendMessage$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: sendMessage
});
...
const getClientManifest = () => import('file://D:/nuxt3-vuetify3-starter-main/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://D:/nuxt3-vuetify3-starter-main/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
