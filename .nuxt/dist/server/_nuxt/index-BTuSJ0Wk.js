...
const _imports_7 = "" + __buildAssetsURL("76636daefdd44b058addb6c6bd1ac107.CkryDl_V.jpg");
      ...
      ssrRenderList(__props.questions, (item, index2) => {
        ...
        ssrRenderList(item.content, (block, blockIndex) => {
          ...
          if (block.type === "highlighted-text") {
            _push(`<p class="highlighted-text" data-v-0fd979cf>${splitText(block.text) ?? ""}</p>`);
          } else {
            _push(`<!---->`);
          }
          if (block.type === "highlighted-background-text") {
            _push(`<p class="highlighted-background-text" data-v-0fd979cf>${splitText(block.text) ?? ""}</p>`);
          } else {
            _push(`<!---->`);
          }
          if (block.type === "text") {
            _push(`<p class="question__text" data-v-0fd979cf>${splitText(block.text) ?? ""}</p>`);
          } else {
            _push(`<!---->`);
          }
          if (block.type === "list") {
            ...
            ssrRenderList(block.lists, (list, listIndex) => {
              ...
              if (list.title) {
                _push(`<p class="question__list-title" data-v-0fd979cf>${splitText(list.title) ?? ""}</p>`);
              } else {
                _push(`<!---->`);
              }
              _push(`<ul class="question__list" data-v-0fd979cf><!--[-->`);
              ssrRenderList(list.items, (listItem, itemIndex) => {
                _push(`<li class="question__list-item" data-v-0fd979cf><p data-v-0fd979cf>${splitText(listItem) ?? ""}</p></li>`);
              });
              _push(`<!--]--></ul></div>`);
            });
            _push(`<!--]--></div></div>`);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (currentStep.value === 1) {
        _push(`<div class="quiz__step" data-v-6eb13c1d><h2 class="quiz__title" data-v-6eb13c1d> Укажите примерную площадь мягкого остекления в м² </h2><div class="quiz__slider-container" data-v-6eb13c1d><div class="quiz__slider-wrapper" style="${ssrRenderStyle(sliderProgressStyle.value)}" data-v-6eb13c1d><input type="range" min="1" max="100"${ssrRenderAttr("value", answers.value.area)} class="quiz__slider" data-v-6eb13c1d></div><p class="quiz__slider-value" data-v-6eb13c1d>${ssrInterpolate(answers.value.area)} м²</p></div></div>`);
      } else {
        _push(`<!---->`);
      }
...
//# sourceMappingURL=index-BTuSJ0Wk.js.map
