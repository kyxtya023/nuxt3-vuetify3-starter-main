...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div></div></div></section><div class="price" id="price" data-v-9f054e0e><div class="container" data-v-9f054e0e><div class="price__inner" data-v-9f054e0e><h2 class="price__title" data-v-9f054e0e> Стоимость <span class="orange" data-v-9f054e0e>Мягких Окон</span> в готовой комплектации </h2><div class="price-table" data-v-9f054e0e><div class="price-table__row price-table__header" data-v-9f054e0e><div class="header__cell" data-v-9f054e0e>Наименование</div><div class="header__cell" data-v-9f054e0e>До 15 м²</div><div class="header__cell" data-v-9f054e0e>От 15 м² до 50 м²</div><div class="header__cell" data-v-9f054e0e>Более 50 м²</div></div><!--[-->`);
      ssrRenderList(services, (item, index2) => {
        ...
        if (isMobile.value) {
          _push(`<span data-v-9f054e0e>${ssrInterpolate(item.prices[0])} <span class="price-table__cell-text-gray" data-v-9f054e0e>До 15 м²</span></span>`);
        } else {
          _push(`<span data-v-9f054e0e>${ssrInterpolate(item.prices[0])}</span>`);
        }
        _push(`</div><div class="price-table__cell" data-v-9f054e0e>`);
        if (isMobile.value) {
          _push(`<span data-v-9f054e0e>${ssrInterpolate(item.prices[1])} <span class="price-table__cell-text-gray" data-v-9f054e0e>От 15 м² до 50 м²</span></span>`);
        } else {
          _push(`<span data-v-9f054e0e>${ssrInterpolate(item.prices[1])}</span>`);
        }
        _push(`</div><div class="price-table__cell" data-v-9f054e0e>`);
        if (isMobile.value) {
          _push(`<span data-v-9f054e0e>${ssrInterpolate(item.prices[2])} <span class="price-table__cell-text-gray" data-v-9f054e0e>Более 50 м²</span></span>`);
        } else {
          _push(`<span data-v-9f054e0e>${ssrInterpolate(item.prices[2])}</span>`);
        }
        _push(`</div></div>`);
      });
      _push(`<!--]--></div></div></div></div><div class="mosquito-table" data-v-9f054e0e><div class="container" data-v-9f054e0e><div class="mosquito-table__inner" data-v-9f054e0e><h2 class="price__title" data-v-9f054e0e> Москитная <span class="orange" data-v-9f054e0e>Сетка</span></h2><div class="price-table" data-v-9f054e0e><div class="price-table__row price-table__header" data-v-9f054e0e><div class="header__cell" data-v-9f054e0e>Наименование</div><div class="header__cell" data-v-9f054e0e>До 15 м²</div><div class="header__cell" data-v-9f054e0e>От 15 м² до 50 м²</div><div class="header__cell" data-v-9f054e0e>Более 50 м²</div></div><div class="price-table__row" data-v-9f054e0e><div class="price-table__cell" data-v-9f054e0e><div class="service-info" data-v-9f054e0e><img${ssrRenderAttr("src", _imports_7)} alt="Комплект «Москитная сетка»" class="service-info__image" data-v-9f054e0e><div class="service-info__content" data-v-9f054e0e><h3 class="service-info__title" data-v-9f054e0e> Комплект «Москитная сетка» </h3><p class="service-info__description" data-v-9f054e0e> Москитная Сетка Ю. Корея плотность 250 г.м с армированной нитью, морозостойкая до -35°C, окантовка ПВХ или Оксфорд, (без фурнитуры) </p></div></div></div><div class="price-table__cell" data-v-9f054e0e>`);
      if (isMobile.value) {
        _push(`<span data-v-9f054e0e> от 1200 руб. <span class="price-table__cell-text-gray" data-v-9f054e0e>До 15 м²</span></span>`);
      } else {
        _push(`<span data-v-9f054e0e>от 1200 руб.</span>`);
      }
      _push(`</div><div class="price-table__cell" data-v-9f054e0e>`);
      if (isMobile.value) {
        _push(`<span data-v-9f054e0e> от 1100 руб. <span class="price-table__cell-text-gray" data-v-9f054e0e>От 15 м² до 50 м²</span></span>`);
      } else {
        _push(`<span data-v-9f054e0e>от 1100 руб.</span>`);
      }
      _push(`</div><div class="price-table__cell" data-v-9f054e0e>`);
      if (isMobile.value) {
        _push(`<span data-v-9f054e0e> от 1000 руб. <span class="price-table__cell-text-gray" data-v-9f054e0e>Более 50 м²</span></span>`);
      } else {
      ...
      if (currentStep.value === 1) {
        _push(`<div class="quiz__step" data-v-9f054e0e><h2 class="quiz__title" data-v-9f054e0e> Укажите примерную площадь мягкого остекления в м² </h2><div class="quiz__slider-container" data-v-9f054e0e><div class="quiz__slider-wrapper" style="${ssrRenderStyle(sliderProgressStyle.value)}" data-v-9f054e0e><input type="range" min="1" max="100"${ssrRenderAttr("value", answers.value.area)} class="quiz__slider" data-v-9f054e0e></div><p class="quiz__slider-value" data-v-9f054e0e>${ssrInterpolate(answers.value.area)} м²</p></div></div>`);
      } else {
        _push(`<!---->`);
      }
...
//# sourceMappingURL=index-BWbUqWXl.js.map
