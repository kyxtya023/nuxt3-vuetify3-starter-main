  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(services, (item, index2) => {
        ...
        if (isMobile.value) {
          _push(`<span data-v-adb435f4>${ssrInterpolate(item.prices[0])} <span class="price-table__cell-text-gray" data-v-adb435f4>До 15 м²</span></span>`);
        } else {
          _push(`<span data-v-adb435f4>${ssrInterpolate(item.prices[0])}</span>`);
        }
        _push(`</div><div class="price-table__cell" data-v-adb435f4>`);
        if (isMobile.value) {
          _push(`<span data-v-adb435f4>${ssrInterpolate(item.prices[1])} <span class="price-table__cell-text-gray" data-v-adb435f4>От 15 м² до 50 м²</span></span>`);
        } else {
          _push(`<span data-v-adb435f4>${ssrInterpolate(item.prices[1])}</span>`);
        }
        _push(`</div><div class="price-table__cell" data-v-adb435f4>`);
        if (isMobile.value) {
          _push(`<span data-v-adb435f4>${ssrInterpolate(item.prices[2])} <span class="price-table__cell-text-gray" data-v-adb435f4>Более 50 м²</span></span>`);
        } else {
          _push(`<span data-v-adb435f4>${ssrInterpolate(item.prices[2])}</span>`);
        }
        _push(`</div></div>`);
      });
      _push(`<!--]--></div></div></div></div><div class="mosquito-table" data-v-adb435f4><div class="container" data-v-adb435f4><div class="mosquito-table__inner" data-v-adb435f4><h2 class="price__title" data-v-adb435f4> Москитная <span class="orange" data-v-adb435f4>Сетка</span></h2><div class="price-table" data-v-adb435f4><div class="price-table__row price-table__header" data-v-adb435f4><div class="header__cell" data-v-adb435f4>Наименование</div><div class="header__cell" data-v-adb435f4>До 15 м²</div><div class="header__cell" data-v-adb435f4>От 15 м² до 50 м²</div><div class="header__cell" data-v-adb435f4>Более 50 м²</div></div><div class="price-table__row" data-v-adb435f4><div class="price-table__cell" data-v-adb435f4><div class="service-info" data-v-adb435f4><img${ssrRenderAttr("src", _imports_7)} alt="Комплект «Москитная сетка»" class="service-info__image" data-v-adb435f4><div class="service-info__content" data-v-adb435f4><h3 class="service-info__title" data-v-adb435f4> Комплект «Москитная сетка» </h3><p class="service-info__description" data-v-adb435f4> Москитная Сетка Ю. Корея плотность 250 г.м с армированной нитью, морозостойкая до -35°C, окантовка ПВХ или Оксфорд, (без фурнитуры) </p></div></div></div><div class="price-table__cell" data-v-adb435f4>`);
      if (isMobile.value) {
        _push(`<span data-v-adb435f4> от 1200 руб. <span class="price-table__cell-text-gray" data-v-adb435f4>До 15 м²</span></span>`);
      } else {
        _push(`<span data-v-adb435f4>от 1200 руб.</span>`);
      }
      _push(`</div><div class="price-table__cell" data-v-adb435f4>`);
      if (isMobile.value) {
        _push(`<span data-v-adb435f4> от 1100 руб. <span class="price-table__cell-text-gray" data-v-adb435f4>От 15 м² до 50 м²</span></span>`);
      } else {
        _push(`<span data-v-adb435f4>от 1100 руб.</span>`);
      }
      _push(`</div><div class="price-table__cell" data-v-adb435f4>`);
      if (isMobile.value) {
        _push(`<span data-v-adb435f4> от 1000 руб. <span class="price-table__cell-text-gray" data-v-adb435f4>Более 50 м²</span></span>`);
      } else {
...
//# sourceMappingURL=index-CZsobUjY.js.map
